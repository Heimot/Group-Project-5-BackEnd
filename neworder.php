...
try {
    $db = slDB();
    $query = $db->prepare('insert into orders(customerid,price,shipping,email,firstname,lastname,address,postalcode,city,phone) values (:customerid,:price,:shipping,:email,:firstname,:lastname,:address,:postalcode,:city,:phone)');
    if ($registered) {
